...
const isPartialFormattedRussianPhone = (s) => Boolean(s.match(partialRussianFormattedPhoneRegex));
const stringNumbersPhoneRegex = /^[78]?\d{10}$/;
const isCompleteRussianPhone = (s) => Boolean((0, utils_1.getNumbers)(s).match(stringNumbersPhoneRegex));
const formatRussianPhoneNumber = (s) => {
    let numbers = (0, utils_1.getNumbers)(s);
    let phone = "";
...
function handleInput(event) {
    ...
    if (!inputType || inputType.startsWith("insert")) {
        ...
        const firstDigit = (0, utils_1.getNumbers)(rawValue)[0];
