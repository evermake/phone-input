...
const partialRussianFormattedPhoneRegex =
  /^((?:\+|$)(?:7|$)|(?:8|$)|$)(?: |$)(?:\(|$)(?:\d|$)(?:\d|$)(?:\d|$)(?:\)|$)(?: |$)(?:\d|$)(?:\d|$)(?:\d|$)(?:-|$)(?:\d|$)(?:\d|$)(?:-|$)(?:\d|$)(?:\d|$)$/
const isPartialFormattedRussianPhone = (s: string) =>
  Boolean(s.match(partialRussianFormattedPhoneRegex))

const stringNumbersPhoneRegex = /^[78]?\d{10}$/
const isCompleteRussianPhone = (s: string) =>
  Boolean(getNumbers(s).match(stringNumbersPhoneRegex))
...
function handleInput(event: InputEvent) {
  ...
  if (!inputType || inputType.startsWith("insert")) {
    ...
    if (
      completedValue.length < rawValue.length &&
      isPartialFormattedRussianPhone(rawValue)
    ) {
